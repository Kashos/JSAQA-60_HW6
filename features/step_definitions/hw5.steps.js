...
When("выбирает время сеанса фильма Терминатор-заржавел на 10-00", async function () {
  await this.page.waitForTimeout(1000);
  return await clickElement(this.page, 'body > main > section:nth-child(2) > div.movie-seances__hall > ul > li > a');
});

When("выбирает место в зале кинотеатра 5 ряд 10 место", async function () {
  await this.page.waitForSelector('div.buying-scheme');
  await this.page.waitForTimeout(500);
  await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(5) > span:nth-child(10)');
...
When(
    "выбирает время сеанса фильма Зверополис на 11-00",
    async function () {
      await this.page.waitForTimeout(1000);
...
When(
  "выбирает места в зале кинотеатра 9 ряд 3,4,5 места",
  async function () {
    await this.page.waitForSelector('div.buying-scheme');
    await this.page.waitForTimeout(500);
    await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(9) > span:nth-child(3)');
    await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(9) > span:nth-child(4)');
    await clickElement(this.page, 'body > main > section > div.buying-scheme > div.buying-scheme__wrapper > div:nth-child(9) > span:nth-child(5)');
    await clickElement(this.page, 'button');
  }
);
